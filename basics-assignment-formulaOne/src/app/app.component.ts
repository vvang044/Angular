//cd into preferred location but not the project
// run the command ng new dragdrop
// cd into the project and run ng add @angular/material
...
export class AppComponent {
  title = 'basics-assignment-formulaOne';
  ...
  //create another array of drivers for pole position
  altDrivers = [
    { 
      name: 'CARLOS SAINZ', 
      car: 'RENAULT', 
  ...
  // current = Date.now();
  // days = new Date(2020,3,13,0,0).getDay();
  // hours = new Date(2020,3,13,23,59).getHours();
  // difference = this.current - this.hours;